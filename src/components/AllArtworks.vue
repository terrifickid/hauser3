<template>
  <div id="allartworks" class="hero-pad">
    <div class="container">
      ...
      <div class="row mt-5">
        <div
          v-ani="{ class: 'fade-in-bottom', delay: 100 }"
          class="d-none d-lg-block col-3 col-xl-2"
          v-if="!master.hide_filters"
        >
          <ul class="child mb-3">
            <li
              class="mb-2"
            ...
            >
              ...
              >
                <div
                  ...
                  :style="{
                    backgroundImage:
                      'url(' + artwork.acf.hero_image.sizes.medium + ')'
                  }"
                >
                  <img
                    style="width: 100%;"
