        ...
        <div class="col-md-10 offset-md-1">
          ...
          <div class="row">
            ...
            >
              <a class="artwork" :href="'/artwork/' + artwork.slug">
                ...
                <p v-html="artwork.title.rendered">
                  <br />
              ...
              <p>
                <a
                  v-if="artwork.acf.pdf_download.url"
                  :href="artwork.acf.pdf_download.url"
                  ><img class="ico" src="../assets/pdficon.svg"/></a
          ...
          <div class="row share">
            <div class="col-12 col-lg-6">
              <h5 class="p-0 m-0">Share Favorites</h5>
              <br />
              <input
                ref="shareLink"
                type="text"
              ...
              /><br />
              <a @click="copy()"
                ><img class="ico" src="../assets/shareicon.svg" /> Click here to
                copy share link</a
              >
            </div>
          </div>
...
export default {
  ...
  computed: {
    shareLink() {
      var string = this.favoriteArtworks
        .map(artwork => {
          return artwork.slug;
        })
        .toString();
