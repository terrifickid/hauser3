  ...
  <div id="Artwork" class="">
    ...
    <div v-if="artwork">
      ...
      >
        <div
          ref="fixMarker"
          style=" position: absolute; bottom: 50vh; width: 100%"
        ></div>
        <div class="container">
          <div class="row" style="min-height: 100vh;">
            <div class="d-none col-xl-2 d-xl-block ">
              <div style="bottom: 3rem; " class="fixed">
                <div
                  v-bind:class="{ 'fade-in-bottom': masterOn }"
                  v-if="masterOn && artwork.acf.hero_audio.url"
                  class="row d-flex align-items-center "
                >
                  <div style="width: 40px; float: left; margin-left: 14px;">
                    <a
                      @click="clickAudio()"
                      v-bind:class="{ heartbeat: playAudio }"
                      class="avatar"
                      v-bind:style="{
                        'background-image':
                          'url(' + artwork.acf.hero_audio_avatar.url + ')'
                      }"
                    >
                      <div
                        v-bind:class="{ playBoxShow: playAudio }"
                        class="playBox"
                      >
                        <b-icon
                          v-show="!playAudio"
                  ...
                  <div style="padding-left: 3px;" class="col">
                    <div
                      class="ml-2"
                      v-html="artwork.acf.hero_audio_caption"
                    ></div>
                  </div>
                </div>
              </div>
            ...
            <div
              id="heroCont"
              class="col-10 offset-1 col-lg-6 offset-lg-0 col-xl-6 offset-xl-1 d-flex align-items-center"
            >
              <div
                v-if="!artwork.acf.hero_3d_ && artwork.acf.hero_image"
              ...
              <Lottie
                ref="lottie"
                v-if="artwork.acf.hero_3d_"
                :url="artwork.acf.hero_3d_"
              ></Lottie>
            </div>
            <!-- enffd col -->
            <div class="d-none d-lg-block col-lg-3 offset-lg-1 offset-xl-0">
              <div class="fixed rightCol">
                ...
                <div>
                  ...
                  <p class="mb-3">
                    <a href="#details"
                      >About the artwork <b-icon class="ml-2" icon="arrow-right"
                    /></a>
                  </p>
                  <p class="mb-3">
      ...
      <!-- end grey -->
      <div
        style="border: 0px solid red; position: relative; top: 5rem;"
        ref="breakPoint"
      ></div>
      ...
      <div class="artwork_images">
        <div class="container">
          <div
            class=" artwork col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-6 offset-lg-0 offset-xl-3"
